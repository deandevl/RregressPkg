...
### Show the fit and confidence interval values
```{r}
RplotterPkg::create_table(
  x = confidence_df,
  caption = "Confidence intervals for College GPA Predictors"
)
```
...
### Call RregressPkg::ols_predict_calc() with "prediction" interval
...
RplotterPkg::create_table(
  x = prediction_df,
  caption = "Prediction intervals for College GPA Predictors"
)
```

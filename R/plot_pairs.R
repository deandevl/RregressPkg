...
#'
#' In creating the \code{var_name_scaling} list, if we are looking at some regression model,
...
#'  matrix like fashion.
#' @param var_name_scaling A required named list where the name is the variable name from \code{df} 
#'   and the value is a vector defining the corresponding major axis scaling breaks. If the value
#'   is NULL, then ggplot2 figures out the variable's scaling. The vector can be numeric/dates or

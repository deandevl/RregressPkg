...
#' @param x_title A string that sets the observed response x axis title. If NULL then 
#'  the x axis title does not appear. The default is "Observation ID".
#' @param y_title A string that sets the fitted response y axis title. If NULL then 

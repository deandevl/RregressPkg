...
#' @param x_title A string that sets the x axis title. The default is "Predictor". If NULL then the x axis title does not appear.
#' @param y_title A string that sets the y axis title. The default is "Response". If NULL then the y axis title does not appear.
...
#' @param line_width A numeric value that sets the thickness of lines if \code{connect} is TRUE.

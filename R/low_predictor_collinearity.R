...
#' \enumerate{
#'   \item \dQuote{predictors} A character vector with the names of predictors with pairwise low collinearity among themselves.
#'   \item \dQuote{correlations} The correlation matrix with just the selected predictors.
#'   \item \dQuote{max_correlation} The maximum correlation among all pairs of the selected predictors.
#' }
#'
#' @author Rick Dean
#'
